...
class ChatScreen extends StatefulWidget {
  ...
  ChatScreen(this.product_name, this.phoneno, this.email, this.name, this.state,
      this.rewards, this.age, this.sex);
  @override
            ...
            new Row(
                ...
                children: <Widget>[
                  new IconButton(
                      ...
                      onPressed: () =>
                          _handleSubmit(_chatController.text, "Anonymous")),
                  new IconButton(
                      icon: new Icon(Icons.send),
                      onPressed: () =>
                          _handleSubmit(_chatController.text, this.name)),
                ])
          ],
        ),
      ),
